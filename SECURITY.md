...
ARF is intended to manage private community event information. Treat member profiles, RSVP state, survey answers, organizer notes, and rental planning data as sensitive.
...
- Do not store payment method data in ARF.
- Keep ARF source availability aligned with AGPLv3 obligations.
