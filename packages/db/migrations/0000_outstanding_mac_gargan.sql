CREATE TYPE "public"."crm_sync_status" AS ENUM('pending', 'success', 'failed');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "crm_sync_log" ADD CONSTRAINT "crm_sync_log_member_id_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "crm_sync_log" ADD CONSTRAINT "crm_sync_log_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "crm_sync_log_member_id_idx" ON "crm_sync_log" USING btree ("member_id");--> statement-breakpoint
CREATE INDEX "crm_sync_log_event_id_idx" ON "crm_sync_log" USING btree ("event_id");--> statement-breakpoint
...
CREATE INDEX "members_crm_contact_id_idx" ON "members" USING btree ("crm_contact_id");--> statement-breakpoint
